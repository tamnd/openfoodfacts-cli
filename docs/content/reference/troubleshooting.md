...
Most of these come down to network reality or how openfoodfacts serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openfoodfacts rate-limits like any public site. openfoodfacts already paces
...
Where a surface is gated, openfoodfacts reads a cookie or token you supply
...
`openfoodfacts`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openfoodfacts actually did
