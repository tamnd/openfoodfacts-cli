...
```
openfoodfacts <command> [arguments] [flags]
```

Run `openfoodfacts <command> --help` for the full flag list on any command. This
...
per operation you declare in `openfoodfacts/domain.go`.
